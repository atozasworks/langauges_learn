...
<div class="dashboard-container">
    ...
    <div class="dashboard-content">
        <div class="welcome-card">
            ...
            <a href="<?php echo htmlspecialchars(appPath('/index.php')); ?>" class="btn btn-primary" style="margin-top:24px;margin-right:12px;width:auto;padding:10px 24px;text-decoration:none;">← Back to App</a>
