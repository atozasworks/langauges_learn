<?php
/**
 * Send OTP endpoint — generates 4-digit OTP, saves to JSON, sends via SMTP.
 */
...
try {
    ...
    $msg = $e->getMessage();
    if (stripos($msg, 'Cannot open file') !== false || stripos($msg, 'Cannot lock') !== false) {
        $clientMsg = 'Data storage error. Please contact support.';
